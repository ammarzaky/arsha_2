...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <!-- <a href="/" class="logo me-auto"><img src="/front/assets/img/logo.png" alt="" class="img-fluid"></a>-->
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="/admin">Dashboard </a>
                    </li>
    ...
    <footer id="footer">
        ...
        {{-- <div id="footer" class="footer-newsletter">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="bx bx-chevron-right"></i> <a href="{{ route('services') }}">Terms of
                                    service</a></li>
                            {{-- <li><i class="bx bx-chevron-right"></i> <a href="{{route('index')}}">Privacy policy</a></li> --}}
                        </ul>
                    </div>
